...
% The whole fitting thing may be completely unnecessary
...
%     vfx = interp2(gradX, xy(1,:), xy(2,:), 'cubic')/2;
%     vfy = interp2(gradY, xy(1,:), xy(2,:), 'cubic')/2;
...
%     int_start = interp2(fibSegImg, xy(1,1), xy(2,1), 'cubic');
%     int_end = interp2(fibSegImg, xy(1,end), xy(2,end), 'cubic');
%     
